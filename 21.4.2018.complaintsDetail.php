								...
								<div class="row">
									...
									<div class="col-lg-2 col-md-2 col-sm-2 hide-user-icon">
										...
										<div class="content img-circle user-complaint text-center">
											...
											<p class="text-uppercase" style="padding-top:10px;"><b><?php echo $complaintUserId[0]['nickName'][0];?></b></p>
									...
									<div class="col-lg-2 col-md-2 col-sm-2 hide-user-icon">
										...
										<div class="content img-circle user-complaint text-center">
											...
											<?php
												...
												$icon = $User->query("SELECT `groupId`, `nickName`, `siteName` FROM `tblUser` WHERE `id` = '" . $val['userId'] . "'");
											...
											<p class="text-uppercase" style="padding-top:10px;" title="<?php echo $icon[0]['nickName'];?>"><b><?php echo $icon[0]['nickName'][0];?></b></p>
											...
											<p class="text-uppercase" style="padding-top:10px;"><b>BTA</b></p>
