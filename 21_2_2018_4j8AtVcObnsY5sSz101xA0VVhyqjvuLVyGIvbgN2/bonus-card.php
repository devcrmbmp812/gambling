			...
			<div class="panel-body">
				<div class="content">
					...
					<div class="field-wrap form-group">
						<textarea name="bonusDesc" rows="4" placeholder="Bonus Description" required></textarea>
					</div>
					<div class="field-wrap">
						<div class="field-wrap-half form-group">
						...
						?>
							<tr>
								...
								<td>
									...
									<a href="<?php echo C::link('bonus-card.php', array('delete' => $value['id']), true);?>" class="btn btn-danger btn-xs text-white"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
						<?php
							}
