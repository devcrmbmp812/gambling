				...
				<div class="details-page">
					...
					<div class="ask-mobile-table">
						...
						<table class="ask-table">
							...
							<tr>
								<td>최대 당첨금</td>
								<td class="text-yellow"><b>원<?php echo $_SESSION['value']['0']['maxPrizeMoney']; ?></b></td>
							</tr>
							<tr>
								<td>단폴더 조건</td>
							...
							<tr>
								<td>크로스 배팅</td>
								<td class="text-yellow"><b><?php echo $_SESSION['value']['0']['crossBetting']; ?></b></td>
							</tr>
							<tr>
								<td>미니게임</td>
								...
								<div class="col-xs-12" id="formobile">
									<div class="media">
									  	...
									  	<div class="media-body">
											...
											<a href="http://<?php echo $data['link'];?>" class="btn btn-default mobile-button"><b>GET NOW</b></a>
									  	</div>
									</div>
								</div><!--col-xs-12-->
								<?php
								...
								<form action="" method="post" enctype="multipart/form-data">
									<div class="col-lg-12 col-md-12 postComment">
										...
										<div class="col-md-10 col-md-offset-2">
		                                    ...
		                                    <p class="text-white"><input type="checkbox" name="checkPost" required/><span style="margin-left:15px;">I declare that my review is based on my own experience and represents my genuine opinion of this casino. I'm not a casino employee and have not been offered any incentive or payment by the casino to write this review. I understand that AskGamblers has zero-tolerance policy on fake reviews. </span></p>
		                                    <div style="margin-top:20px;margin-bottom:10px;">
		                                    	<button type="submit" class="btn btn-ask-red" style="margin:0px 20px 0px 0px;">작성하기</button><a href="posting-guidlines.php" class="text-yellow text-mobile">댓글 가이드 라인 확인하기</a>
	                                    	</div>
										</div>
									</div>
								</form>
