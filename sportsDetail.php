			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="image-bg">
				...
				<div class="col-sm-12 content-button">
					...
					<div class="col-sm-4">
						...
						<a href="http://<?php echo $_SESSION['value']['0']['link']; ?>" class="btn btn-ask-red btn-w100 text-capitalize padding10 font15" target="_blank"><b><i class="fa fa-reply-all margin-right-5" aria-hidden="true"></i> 사이트 바로가기</b></a>
								...
								<div class="col-xs-12" id="formobile">
									...
									<div class="media">
									  	...
									  	<div class="media-body">
											...
											<a href="http://<?php echo $data['link'];?>" class="btn btn-default mobile-button" target="_blank"><b>GET NOW</b></a>
