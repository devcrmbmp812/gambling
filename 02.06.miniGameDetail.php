				...
				<div class="details-page">
					...
					<div class="ask-mobile-table">
						<table class="ask-table text-center">
							<tr>
								<td colspan="2">
									<div class="details-page-logo" align="center">
						...
						<table class="ask-table">
							...
							<tr>
								<td class="text-yellow">Min Betting Amount</td>
								<td><?php echo $_SESSION['value']['0']['minBettingAmount']; ?></td>
							</tr>
							<tr>
								<td class="text-yellow">Rolling Bonus</td>
								<td>원<?php echo $_SESSION['value']['0']['rollingBonus']; ?></td>
							</tr>-->
						</table>
					</div>
							...
							<div class="ask-page-content-body-details"> 
								<div class="row content">
									...
									?>
										...
										<tr>
											<td>Cross Bettingaaaaaaaaaaaa :</td>
